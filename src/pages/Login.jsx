...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.success) {
                ...
                alert(`Login successful! Welcome ${result.user.email} (${result.user.role})`);
                navigate('/');
            } else {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-black flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
